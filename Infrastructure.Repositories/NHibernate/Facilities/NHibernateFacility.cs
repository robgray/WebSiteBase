...
namespace Infrastructure.Repositories.NHibernate.Facilities
{
    ///<summary>
    ...
    public class NHibernateFacility : AbstractFacility
    {
        ...
        public NHibernateFacility()
            : this(DefaultSessionLifeStyleOption.SessionPerTransaction, FlushMode.Auto)
        {
        }
        ...
        public NHibernateFacility(DefaultSessionLifeStyleOption defaultLifeStyle)
            : this(defaultLifeStyle, FlushMode.Auto)
        {
        }
		...
		/// <summary>
		/// Gets or sets whether to write all SQL statements to console.
		/// </summary>
        ...
        protected override void Init()
        {
            ...
            var installed = installers
				...
				.Do(x => { if (ShowSql) x.Config.SetProperty("show_sql", "true"); })
                ...
                .Do(x => Kernel.Register(
                    ...
                    // Using this code requires MSDTC and instantiates multiple sessions per webrequest.
                    // The OrDefault part is always called.
                    // It should not be doing this!  Not sure why it is :S
                    //
                    //Component.For<ISessionManager>().Instance(new SessionManager(() =>
                    //{
