...
namespace Mvc.Tests
{
    ...
    public abstract class WindsorConventionTest : ConventionTestBase
    {
        public override void Execute()
        {
            ...
            {
                Assert.Inconclusive(
                    "No handlers found to apply the convention to. Make sure the handler predicate is correct and that the right components were registered in the container.");
            }
        ...
        {
	        var x = handler.GetComponentName();
