...
{
    public class DateTimeNow_is_not_used : ConventionTest
    {
        protected override ConventionData SetUp()
        {
            return new ConventionData
            {
                ...
                FailDescription =
                    "Classes must not make use of System.DateTime.Now.\n\tThe following methods use System.DateTime.Now. (Please use DateTimeHelper.UtcNow instead)\n",
        ...
        private IEnumerable<string> GetDateTimeNowUsages(Type type)
        {
            ...
            var q = from typedef in assembly.MainModule.Types.Where(t => t.Name == type.Name)
                    ...
                    where
                        methodRef != null && methodRef.FullName == "System.DateTime System.DateTime::get_Now()"
